...
import Example from '@/features/javascript-example';
...
Load the CSS and JavaScript files from a CDN. The example below is hosted within an `iframe`. You can also view it <a href={demoPath}>here</a>.
