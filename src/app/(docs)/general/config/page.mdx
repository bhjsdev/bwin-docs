...
export const metadata = {
  title: 'Config - General - Binary Window',
};
...
Each pane holds a <a href={getPath('/general/glass')}>glass</a> (its header and content). See <a href={getPath('/general/pane')}>Pane</a> and <a href={getPath('/general/glass')}>Glass</a> for how those pieces fit together.
...
- <a href={getPath('/javascript/get-started')}>JavaScript — Get started</a>
- <a href={getPath('/react/get-started')}>React — Get started</a>
