...
You don't need any build tools to use Binary Window. Just include the CSS and JS files directly in your HTML file.
  ...
  <head>
    ...
    <script type="module">
      ...
      const bwin = new BinaryWindow({
        ...
        height: 400,
        children: [
          { position: 'left', size: 300, content: element },
          {
            position: 'right',
            children: [
