...
2. NEVER commit or push unless explicitly asked. Authorization is per-message and single-use: a "commit"/"ok" approves only the commit in that exact turn. It does NOT carry to later changes — every subsequent commit needs a fresh, explicit request.
